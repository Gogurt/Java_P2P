...
public class Server extends JFrame
{
    ...
    class ClientThread implements Runnable
    {
        ...
        public void run()
        {
            ...
            try {
                ...
                output.println("Welcome to the server " + username + "! There are " + numberOfUsers + " peers online.");
                
                peerPortListener = input.readLine().toString();
                
                //Add the chat to the text box
                chatBox.append(username + " has connected!\n");
                chatBox.append("Their personal listening port is " + peerPortListener + "\n");
                System.out.println(username + " has connected!");
            	System.out.println("Their personal listening port is " + peerPortListener);
            	...
            	newPeer = new Peer(username, threadSocket.getRemoteSocketAddress().toString(), peerPortListener, availableFiles);
    ...
    public class Peer {
		...
		public Peer(String username, String ip, String port, ArrayList<String> availableFiles) {
